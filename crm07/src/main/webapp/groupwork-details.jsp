    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            aria-valuenow="${pendingTasks}" aria-valuemin="0" aria-valuemax="100" style="width: ${pendingTasks}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-megna" role="progressbar"
                                            aria-valuenow="${inProgressTasks}" aria-valuemin="0" aria-valuemax="100" style="width: ${inProgressTasks}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-primary">${finishedTasks}%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" role="progressbar"
                                            aria-valuenow="${finishedTasks}" aria-valuemin="0" aria-valuemax="100" style="width: ${finishedTasks}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <c:forEach items="${ userTasks }" var="item">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            	<c:forEach items="${item.value['Chưa thực hiện']}" var="taskItem">
                            	
	                                <a href="#">
	                                    <div class="mail-contnet">
	                                        <h5>${ taskItem.user }</h5> 
	                                        <span class="mail-desc">${ taskItem.taskName }</span> 
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach items="${item.value['Đang thực hiện']}" var="taskItem">
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach items="${item.value['Đã hoàn thành']}" var="taskItem">
